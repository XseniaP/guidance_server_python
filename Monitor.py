from SharedConsts import State, PATH2SAVE_MONITOR_DATA, SEPERATOR_FOR_MONITOR_DF
import os
...
class Monitor_Jobs:
    ...
    def update_monitor_data(self, process_id, state, job_prefix, parameters):
        ...
        path2monitor_data = f'{os.path.join(PATH2SAVE_MONITOR_DATA, process_id, process_id)}.csv'
