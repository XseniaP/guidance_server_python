...
class RunConfig:
  ...
  --proc_num <num of processors to use> default=1"
    ...
    def parse_arguments(self):
        ...
        # Optional parameters
        parser.add_argument('--program', dest='PROGRAM', type=str, choices=['GUIDANCE', 'HoT', 'GUIDANCE3'],
                            default='GUIDANCE3',
                            help='Specify the program to run (optional): HoT or GUIDANCE3. Default is GUIDANCE3.')
    ...
    def validate_sequences(self):
        ...
        if self.NumOfSeq < 4 and self.PROGRAM == "GUIDANCE3":
            exit_on_error('user_error',
    ...
    def server_input_mode_arguments(self):
        ...
        if self.CALLING_SERVER == "GUIDANCE3":
            self.overview_URL = "http://guidance.tau.ac.il/ver2/overview.php"
            self.gallery_URL = "http://guidance.tau.ac.il/ver2/Gallery.php"
            self.home_URL = "http://guidance.tau.ac.il/"
    ...
    def set_rest_of_the_variables(self):
        ...
        self.GUIDANCE3_MSAs_Dir = f"{self.BootStrap_Dir}GUIDANCE3_MSA/"
        self.Tree_File = ""
        self.Semphy_OutFile = ""
        self.Semphy_LogFile = ""
        self.Semphy_StdFile = ""
