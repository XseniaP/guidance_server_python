...
from guidance3.dl_model.config.config import PickBestConfig
...
pickbest_cfg = PickBestConfig(
    ...
    error=0.0,
    subset=None,
    out_dir="/Users/kpolonsky/Documents/sp_alternative/dl_model/out/", #replace with your output folder path
    num_trials=1
)
